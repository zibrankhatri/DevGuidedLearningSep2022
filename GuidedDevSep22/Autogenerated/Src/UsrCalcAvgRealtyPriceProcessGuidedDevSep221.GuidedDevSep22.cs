namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAvgRealtyPriceProcessGuidedDevSep221MethodsWrapper

	/// <exclude/>
	public class UsrCalcAvgRealtyPriceProcessGuidedDevSep221MethodsWrapper : ProcessModel
	{

		public UsrCalcAvgRealtyPriceProcessGuidedDevSep221MethodsWrapper(Process process)
			: base(process) {
